...
public class LocationExtensions {
    ...
    public static com.telemedicine.telecare.model.address.Address getAddress(double lat, double lng){
        try {
            Geocoder geocoder = new Geocoder(AppController.getContext(), Locale.US);
            /**
            ...
            com.telemedicine.telecare.model.address.Address address = new com.telemedicine.telecare.model.address.Address();
            ...
            e.printStackTrace();
            return new com.telemedicine.telecare.model.address.Address();
        }
    }
}

...
import static com.telemedicine.telecare.util.extensions.AppExtensions.getDrawable;
...
public class CustomPopup {
    ...
    private void showPopupWindow() {
        ...
        popupWindow.setAdapter(adapter != null ? adapter : new ArrayAdapter<>(mContext, R.layout.sample_popup_item, items));

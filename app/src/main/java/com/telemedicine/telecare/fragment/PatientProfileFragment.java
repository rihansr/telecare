...
public class PatientProfileFragment extends DialogFragment {
    ...
    private void init() {
        ...
        String height = patient.getHeight() == null ? "" : AppExtensions.decimalFormat(patient.getHeight(), "#.#", false, AppExtensions.getString(R.string.nullSymbol)) + " " + AppExtensions.getString(R.string.feet_Hint);
        patient_Height.setText(String.format(Locale.getDefault(),"%s", height));

        String weight = patient.getWeight() == null ? "" : AppExtensions.decimalFormat(patient.getWeight(), "#.#", false, AppExtensions.getString(R.string.nullSymbol)) + " " + AppExtensions.getString(R.string.kg_Hint);

...
public class NavPatientsFragment extends Fragment implements AppBaseActivity.OnUserRequestListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void init() {
        ...
        empty_Title.setText(AppExtensions.getString(R.string.emptyPatientRequestsTitle));
        empty_Subtitle.setText(AppExtensions.getString(R.string.emptyPatientRequestsSubtitle));

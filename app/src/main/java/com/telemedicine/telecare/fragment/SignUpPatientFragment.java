...
public class SignUpPatientFragment extends Fragment implements OnBackPressListener {
        ...
        register_Button.setOnClickListener(view -> {
            if(formFlipper.getCurrentView().getId() == R.id.signUp_PersonalInfo_Layout){
                if (!AppExtensions.isInputValid(name_Input, R.string.name_Error)
                        ...
                        || !AppExtensions.isInputValid(birthDate_Input, R.string.birthDate_Error)
                ) return;
        ...
        phone_Input.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if(AppExtensions.isNumberValidate(s.toString())){
                    ...
                    AppExtensions.clearError(phone_Input);
                }
            }
        });
    ...
    private void storeUserData(String uid, String photoLink){
        ...
        patient.setChatOption(true);
        patient.setCallOption(true);
    ...
    private void launchNewActivity(User patient) {
        prefManager.setUserMode(Role.PATIENT);
        prefManager.setSignInData(PreferenceManager.USER_INFO_SP_KEY, new Gson().toJson(patient));
        prefManager.setSignInData(PreferenceManager.USER_EMAIL_SP_KEY, null);
        prefManager.setSignInData(PreferenceManager.USER_PASSWORD_SP_KEY, null);
        prefManager.setSignInData(PreferenceManager.USER_REMEMBER_SP_KEY, false);
